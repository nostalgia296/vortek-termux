...
typedef struct VkContextOptions {
    int vkMaxVersion;
    short maxDeviceMemory;
    short imageCacheSize;
    ResourceMemoryType resourceMemoryType;
    const char* const* exposedDeviceExtensions;
    int exposedDeviceExtensionCount;
} VkContextOptions;

extern VkContext* createVkContextForClient(int clientFd, const VkContextOptions* options, const JMethods* jmethods);
